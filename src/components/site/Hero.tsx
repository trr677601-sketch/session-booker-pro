    ...
    <section id="top" className="relative border-b border-hairline">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-5 pb-20 pt-16 sm:px-8 lg:grid-cols-12 lg:gap-10 lg:pb-32 lg:pt-24">
        <div className="lg:col-span-7 lg:pt-6">
          <div className="mb-8 flex items-center gap-3 text-[10px] uppercase tracking-[0.28em] text-muted-foreground">
            <span className="h-px w-8 bg-accent" />
            Barcelona · Strength &amp; Conditioning
          </div>

          <h1 className="font-display text-[clamp(3rem,9vw,7rem)] leading-[0.92] tracking-tight text-foreground">
            Get strong.<br />
            Stay consistent.<br />
          ...
          <dl className="mt-16 grid grid-cols-3 gap-6 border-t border-hairline pt-8 text-left">
            {[
